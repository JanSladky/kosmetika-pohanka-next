    ...
    sections: [
      {
        ...
        items: [
          ...
          { name: "Poradenství v líčení", price: "800 Kč" },
          { name: "Maskérství - speciální efekty / 1 h /", price: "2000 Kč" },
          { name: "Doprava 1 km", price: "30 Kč" },
        ],
      },
    ],
  },
    ...
    sections: [
      {
        title: "Obočí a řasy",
        items: [
          { name: "Úprava a barvení obočí", price: "250 Kč" },
          { name: "Barvení obočí", price: "100 Kč" },
          { name: "Úprava obočí", price: "170 Kč" },
          { name: "Barvení řas", price: "150 Kč" },
          { name: "Lash lifting řas", price: "650 Kč" },
          { name: "Permanentní prodlužování řas", price: "950 Kč" },
      ...
      },
      {
        ...
        items: [
          { name: "Depilace nad horním rtem", price: "80 Kč" },
          { name: "Depilace brady", price: "100 Kč" },
          { name: "Depilace krku", price: "150 Kč" },
          { name: "Depilace tváře", price: "100 Kč" },
          { name: "Depilace celé ruky", price: "250 Kč" },
          { name: "Depilace poloviny ruky", price: "150 Kč" },
          { name: "Depilace podpaždí", price: "100 Kč" },
      ...
      },
      {
        title: "Kosmetika",
        items: [
          { name: "Odlíčení", price: "30 Kč" },
          { name: "Napářka", price: "30 Kč" },
          { name: "Kosmetická masáž obličeje", price: "300 Kč" },
          { name: "Kosmetická masáž obličeje a dekoltu", price: "400 Kč" },
          { name: "Hloubkové čištění", price: "200 Kč" },
          { name: "Pleťová maska", price: "250 Kč" },
          { name: "Ošetření očního okolí", price: "100 Kč" },
          { name: "Odstranění mília", price: "100 Kč" },
        ],
      },
      {
      ...
      },
      {
        ...
        items: [
          { name: "Chemický peeling", price: "800 Kč" },
          { name: "Retinol peeling", price: "900 Kč" },
        ],
      },
      {
